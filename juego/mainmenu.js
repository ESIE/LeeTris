...
Game.MainMenu.prototype = {
	...
	create : function() {
		...
		this.playbutton = this.add.button(230, 550, 'mapa', this.playclicked, this, 1, 0, 2);
		this.playbutton.anchor.setTo(0.5, 0.5);
		// agregamos el botón "Instrucciones"
		this.playbutton = this.add.button(600, 550, 'instrucciones', this.playclicked, this, 1, 0, 2);
		this.playbutton.anchor.setTo(0.5, 0.5);
		// agregamos el botón "Creditos"
		this.playbutton = this.add.button(970, 550, 'creditos', this.playclicked, this, 1, 0, 2);
		this.playbutton.anchor.setTo(0.5, 0.5);
